...
def bootstrap_roll_back(){
    ...
    try {
        ...
        //Credential of user
       withCredentials([usernamePassword(credentialsId: '094aae41-3d61-483e-a122-265c3f4ce738', usernameVariable: 'username',
...
def bootstrapPushCommitBuild() {
    ...
    if (pushCommitInOpenMR(env.gitlabBranch)) {
        ...
        try{
            ...
            // removeRepoNexusAndcleanEnviroment()
...
def loadCIConfigFile() {
    configFileProvider([configFile(fileId: "its-common-module", targetLocation: 'cicd/')]) {
        load "cicd/its-common-module"
    }
}
...
def isOpenMergeRequest(gitlabMergeRequestIid) {
    withCredentials([
        usernamePassword(credentialsId: '094aae41-3d61-483e-a122-265c3f4ce738', usernameVariable: 'username', passwordVariable: 'password'),
