...
class WarningConfigItemEntityTest {
	...
	@Test
	void WarningConfigItemEntity (){
		BeanMatchers.registerValueGenerator(new ValueGenerator<LocalDateTime>() {
			public LocalDateTime generate() {
				return null;  // Change to generate random instance
		}
		}, LocalDateTime.class);
		assertThat(WarningConfigItemEntity.class, allOf(hasValidBeanConstructor(), hasValidGettersAndSetters()));
	}
