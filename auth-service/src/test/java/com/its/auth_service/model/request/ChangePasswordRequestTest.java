...
class ChangePasswordRequestTest {
	...
	void ChangePasswordRequest (){
		assertThat(ChangePasswordRequest.class, allOf(hasValidBeanConstructor(), hasValidGettersAndSetters()));
	}
